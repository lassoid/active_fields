...
RSpec.describe ActiveFields::Field::Decimal do
  ...
  context "callbacks" do
    ...
    describe "after_create #add_field_to_records" do
      include_examples "field_value_add", :decimal_active_field
      include_examples "field_value_add", :decimal_active_field, :with_min
      include_examples "field_value_add", :decimal_active_field, :with_max
      include_examples "field_value_add", :decimal_active_field, :with_min, :with_max
      include_examples "field_value_add", :decimal_active_field, :required
      include_examples "field_value_add", :decimal_active_field, :required, :with_min
      include_examples "field_value_add", :decimal_active_field, :required, :with_max
      include_examples "field_value_add", :decimal_active_field, :required, :with_min, :with_max
    end
  end
end

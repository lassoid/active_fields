        ...
        context "when value is a datetime" do
          ...
          it "returns only records with such value" do
            ...
            expect(perform_search)
              .to include(*records.select { it.value == casted_value })
              .and exclude(*records.reject { it.value == casted_value })
          end
        end
      ...
      context "with not_eq op" do
        ...
        context "when value is a datetime" do
          ...
          it "returns all records except with such value" do
            ...
            expect(perform_search)
              .to include(*records.reject { it.value == casted_value })
              .and exclude(*records.select { it.value == casted_value })
          end
        end
      ...
      context "with gt op" do
        ...
        context "when value is a datetime" do
          ...
          it "returns records greater than the value" do
            ...
            expect(perform_search)
              .to include(*records.select { it.value && it.value > casted_value })
              .and exclude(*records.reject { it.value && it.value > casted_value })
          end
        end

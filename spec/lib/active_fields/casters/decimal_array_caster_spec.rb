...
RSpec.describe ActiveFields::Casters::DecimalArrayCaster do
  ...
  describe "#serialize" do
    ...
    context "when array of numbers" do
      ...
      it { is_expected.to eq(value.map { |el| el.to_d.truncate(max_precision).to_s }) }
    end
    ...
    context "with precision" do
      ...
      context "when array of numbers" do
        ...
        it { is_expected.to eq(value.map { |el| el.to_d.truncate(args[:precision]).to_s }) }
      end
  ...
  describe "#deserialize" do
    ...
    context "when array of numbers" do
      ...
      it { is_expected.to eq(value.map { |el| el.to_d.truncate(max_precision) }) }
    end
    ...
    context "with precision" do
      ...
      context "when array of numbers" do
        ...
        it { is_expected.to eq(value.map { |el| el.to_d.truncate(args[:precision]) }) }
      end
